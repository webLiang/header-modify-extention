...
/** Map navigator.language to a supported locale bundle. */
...
/** Load preferred locale from storage once. */
...
/** Persist and broadcast a locale change. */
...
/** Translate a message key with optional $1 substitutions. */
